...
const (
	ChatService_SendMessage_FullMethodName = "/v1.ChatService/SendMessage"
	ChatService_HealthCheck_FullMethodName = "/v1.ChatService/HealthCheck"
)
